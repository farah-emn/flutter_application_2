...
class HotelFlightDetailsView extends StatefulWidget {
  const HotelFlightDetailsView({super.key});

  @override
  State<HotelFlightDetailsView> createState() =>
      _HotelFlightDetailsViewState();
}

class _HotelFlightDetailsViewState extends State<HotelFlightDetailsView> {
  @override
